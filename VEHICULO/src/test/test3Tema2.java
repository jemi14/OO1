...
try{
			...
			GregorianCalendar f2 = new GregorianCalendar(04,03,2016,20,47,00);
			//Creo recorrido 1
			...
			Posicion p34 = new Posicion(24, -0.6729148346990673d, -1.0803053999093788d, 183, f2);
			...
			System.out.println ("Distancia recorrida de f1 a f2: " +r1.distanciaRecorrida(f2, f1));
			
			
			
			System.out.println("La velocidad media de f1 a f2:" +r1.velocidadMedia(f2, f1));
