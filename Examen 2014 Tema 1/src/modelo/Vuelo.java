...
public class Vuelo {
	...
	public Vuelo(String aerolinea, String lugarDesde, String lugarHasta, LocalDate fechaSalida, LocalTime horaSalida,
			double precio) {
		super();
		this.aerolinea = aerolinea;
		this.lugarDesde = lugarDesde;
	...
	public Vuelo(int idVuelo, String aerolinea, String lugarDesde, LocalDate fechaSalida, LocalTime horaSalida, String lugarHasta) {
		super();
		this.idVuelo = idVuelo;
		this.aerolinea = aerolinea;
		this.lugarDesde = lugarDesde;
	...
	public String toString() {
		return "Vuelo [idVuelo=" + idVuelo + ", aerolinea=" + aerolinea + ", lugarDesde=" + lugarDesde + ", lugarHasta="
				+ lugarHasta + ", fechaSalida=" + Funciones.traerFechaLarga(fechaSalida) + ", horaSalida=" + horaSalida + ", precio=" + precio
				+ "]";
	}
	
	public String toStringSinPrecio() {
		return "Nro de Vuelo"+ idVuelo + " aerolinea=" + aerolinea + ", lugarDesde=" + lugarDesde + ", lugarHasta="
				+ lugarHasta + ", fechaSalida=" + Funciones.traerFechaLarga(fechaSalida) + ", horaSalida=" + horaSalida;
	}
