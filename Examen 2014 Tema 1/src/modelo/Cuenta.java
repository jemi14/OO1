...
public class Cuenta {
	...
	//-------------------------------------------------------//
	public int traerMaximoIdPasaje(){
		int maximoId = 0;
		for (Pasaje pasaje: lstPasajes){
			if (pasaje.getIdPasaje()>maximoId){
				maximoId = pasaje.getIdPasaje();
			}
		}
		return maximoId;
	}
	...
	public boolean agregarPasaje(int idPasaje, Cliente cliente, Vuelo vuelo) throws Exception {
		...
		//int idPasajeProximo=1;
		//idPasajeProximo=traerMaximoIdPasaje()+1;
