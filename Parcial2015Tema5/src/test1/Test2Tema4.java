...
public class Test2Tema4 {
	...
	public static void main(String[] args) {
		...
		System.out.println(recursos.traerLicencia(3));
		System.out.println(recursos.traerLicencia(3).calcularDiasDeLicencia(fFin3)+ " dias");
	
		System.out.println(recursos.traerLicencia(4));
		System.out.println(recursos.traerLicencia(4).calcularDiasDeLicencia(LocalDate.now())+" dias");
